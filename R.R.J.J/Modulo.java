class Modulo { // Define la clase Modulo
    int n1, n2; // Variables para los números

    public Modulo() { // Constructor que inicializa n2 en 1 para evitar división por cero
        this.n1 = 0;
        this.n2 = 1;
    ...
    public int calcularModulo() { // Método que devuelve el módulo
        return n1 % n2; 
    } // Cierre del método calcularModulo
} // Cierre de la clase Modulo